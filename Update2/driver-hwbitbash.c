...
#define BITBASH_DATA_REG            (0)
#define BITBASH_SHIFT_COUNT_REG     (1)
...
/*
** The 'Bit-Bash' Driver Layer extension.
*/
...
/*
** The 'Hardware Bit-Bash' Driver Layer extension.
*/
static int luaU_hwbitbash (lua_State *L) {
    unsigned int shift_val;
    unsigned int shift_count;
    int n;
    ...
    hw_write(shift_val, BITBASH_DATA_REG);
    hw_write(shift_count, BITBASH_SHIFT_COUNT_REG);
